...
{
    public class HookSizeDecreaseAbilitySystem : IExecuteSystem
    {
        private readonly IGroup<GameEntity> _abilities;
        private readonly IGroup<GameEntity> _collectingLoot;
        private readonly IGroup<GameEntity> _hook;

        public HookSizeDecreaseAbilitySystem(GameContext context)
        {
            _abilities = context.GetGroup(GameMatcher
                .AllOf(GameMatcher.DecreaseHookSizeAbility,
                    GameMatcher.Ability,
                    GameMatcher.Target
                ));
