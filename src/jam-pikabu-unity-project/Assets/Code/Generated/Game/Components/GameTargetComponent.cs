...
public partial class GameEntity {
    ...
    public Code.Common.Target target { get { return (Code.Common.Target)GetComponent(GameComponentsLookup.Target); } }
    ...
    public GameEntity AddTarget(int newValue) {
        ...
        var component = (Code.Common.Target)CreateComponent(index, typeof(Code.Common.Target));
