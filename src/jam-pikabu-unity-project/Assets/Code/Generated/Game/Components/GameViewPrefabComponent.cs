...
public partial class GameEntity {
    ...
    public Code.Infrastructure.View.EntityView ViewPrefab { get { return viewPrefab.Value; } }
    public bool hasViewPrefab { get { return HasComponent(GameComponentsLookup.ViewPrefab); } }

    public GameEntity AddViewPrefab(Code.Infrastructure.View.EntityView newValue) {
    ...
    public GameEntity ReplaceViewPrefab(Code.Infrastructure.View.EntityView newValue) {
        var index = GameComponentsLookup.ViewPrefab;
        var component = (Code.Common.ViewPrefab)CreateComponent(index, typeof(Code.Common.ViewPrefab));
        component.Value = newValue;
