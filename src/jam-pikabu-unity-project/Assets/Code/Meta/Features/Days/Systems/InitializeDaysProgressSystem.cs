...
{
    public class InitializeDaysProgressSystem : IInitializeSystem
    {
        private readonly IDaysService _daysService;
        private readonly IGroup<MetaEntity> _days;

        public InitializeDaysProgressSystem(MetaContext context, IDaysService daysService)
        {
        ...
        public void Initialize()
        {
            ...
            _daysService.InitializeDaysProgress(dayProgressData);
        }
