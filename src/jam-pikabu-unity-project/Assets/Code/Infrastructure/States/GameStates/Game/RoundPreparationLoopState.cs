...
{
    public class RoundPreparationLoopState : EndOfFrameExitState
    {
        private readonly GameStateMachine _stateMachine;
        private readonly ISystemFactory _systemFactory;
        private readonly IGameStateHandlerService _gameStateHandlerService;

        private RoundPreparationLoopFeature _roundLoopFeature;
        private InputFeature _inputFeature;

        [Inject]
        public RoundPreparationLoopState
        (
        ...
        public override void Enter()
        {
            ...
            _roundLoopFeature = _systemFactory.Create<RoundPreparationLoopFeature>();
