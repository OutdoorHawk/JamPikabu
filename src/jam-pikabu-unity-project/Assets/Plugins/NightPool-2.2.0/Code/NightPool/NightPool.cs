...
namespace NTC.Global.Pool
{
    public static class NightPool
    {
        ...
        public static T Spawn<T>(T component, Transform parent, Vector3 position = default, 
            Quaternion rotation = default, bool worldPositionStays = false)
            where T : Component
        {
            return
                DefaultSpawn(component.gameObject, position, rotation, parent, worldPositionStays).GetComponent<T>();
        }
        ...
        /// <summary>
        /// Delay here won't work in WebGL, use NightPoolDespawner instead
        /// </summary>
